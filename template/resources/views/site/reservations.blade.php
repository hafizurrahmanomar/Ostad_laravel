        ...
        <section class="s-pagecontent pagecontent">
            ...
            <div class="row width-narrower content-block">
                <div class="column xl-12">
                    ...
                    <form name="rform" id="rform" class="reservation-form" method="post" action=""
                        autocomplete="off">
                        <fieldset class="row">

                            <div class="column xl-6 tab-12">
                                <label for="rname">Name: </label>
                                <input type="text" name="rame" id="rname" class="u-fullwidth"
                            ...
                            <div class="column xl-6 tab-12">
                                ...
                                <input type="text" name="rdate" id="rdate" class="u-fullwidth"
                                    placeholder="eg: 8/01/2023" value="">
                            </div>
