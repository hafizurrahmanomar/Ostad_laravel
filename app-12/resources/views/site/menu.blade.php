                                ...
                                <ul class="menu-list">
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            <h4>Quesadilla</h4>
                                            <p>
                                                Flour tortilla filled with cheese, sautéed onions, and bell peppers.
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Cherry tomatoes, fresh mozzarella, and basil skewered on a stick and
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Creamy dip made with spinach, artichoke hearts, and a blend of cheeses,
                                ...
                                <ul class="menu-list">
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Fresh salmon fillet served with roasted vegetables and garlic mashed
                                                potatoes.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Tender and juicy filet mignon seasoned with herbs, grilled to your
                                                preference, and served with roasted vegetables.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                            <span>$</span>28.50
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Grilled chicken breast tossed with linguine in a basil pesto cream
                                                sauce, garnished with sun-dried tomatoes and parmesan cheese.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                            <span>$</span>18.50
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                A medley of colorful vegetables stir-fried in a savory soy-ginger sauce,
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Grilled portobello mushroom cap served on a brioche bun with melted
                                                Swiss cheese, caramelized onions, and garlic aioli.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                            <span>$</span>14.00
                                ...
                                <ul class="menu-list">
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Creamy vanilla ice cream served with a choice of toppings: chocolate
                                                sauce, caramel, or fresh berries.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                            <span>$</span>4.99
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Greek yogurt topped with fresh strawberries, honey, and a sprinkle of
                                                granola.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Warm, gooey chocolate cake with a molten center, served with a scoop of
                                                vanilla ice cream.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Layers of coffee-soaked ladyfingers and mascarpone cheese, dusted with
                                                cocoa powder and topped with chocolate shavings.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
                                            <span>$</span>7.99
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                Rich and velvety chocolate fondue served with an assortment of fresh
                                ...
                                <ul class="menu-list">
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                A refreshing blend of white rum, fresh mint leaves, lime juice, simple
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                A delicious blend of mixed berries, banana, yogurt, and a touch of honey
                                    ...
                                    <li class="menu-list__item">
                                        <div class="menu-list__item-desc">
                                            ...
                                            <p>
                                                A refreshing drink made with cucumber, lime juice, soda water, and a
                                                hint of mint.
                                            </p>
                                        </div>
                                        <div class="menu-list__item-price">
